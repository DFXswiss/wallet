...
export function DfxConversionInfo({ token, style }: DfxConversionInfoProps): JSX.Element {
  ...
  return show ? (
    ...
    >
      <InfoText
        testID="dfx_kyc_info"
        text={translate(
          'components/DfxConversionInfo',
          'Please note that currently only DFI UTXO can be sold. You can exchange DFI tokens by clicking here.',
        )}
        style={style}
      />
    </TouchableOpacity>
