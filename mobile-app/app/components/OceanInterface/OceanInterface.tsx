...
export function OceanInterface(): JSX.Element | null {
  ...
  const currentTheme = `${
    isLight ? 'bg-white border-t border-gray-200' : 'bg-dfxblue-800 border-t border-dfxblue-900'
  }`;
  return (
    <Animated.View
      style={[
        tailwind('px-5 py-3 flex-row absolute w-full items-center z-10', currentTheme),
        {
          bottom: slideAnim,
          minHeight: 75,
        },
