      ...
      {showKycInfo && (
        ...
        >
          <InfoText
            testID="dfx_kyc_info"
            text={translate(
              'components/DfxKycInfo',
              'Your account needs to get verified once your daily transaction volume exceeds {{KYC_MAX_AMOUNT}} € per day. If you want to increase daily trading limit, please complete our KYC (Know-Your-Customer) process.',
              { KYC_MAX_AMOUNT },
            )}
            style={props.style}
          />
          {isLoadingKyc && (
            <ThemedActivityIndicator
              size="large"
              color={theme.extend.colors.dfxgray[500]}
