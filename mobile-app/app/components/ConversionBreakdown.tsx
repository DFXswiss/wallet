...
export function ConversionBreakdown(props: ConversionBreakdownProps): JSX.Element {
  const { amount = new BigNumber(0) } = props;
  ...
  return (
    <>
      ...
      <NumberRow
        ...
        rhs={{
          value: new BigNumber(props.dfiUtxo?.amount ?? 0)
            .plus(props.mode === 'accountToUtxos' ? amount : amount.negated())
            .toFixed(8),
      ...
      <NumberRow
        ...
        rhs={{
          value: new BigNumber(props.dfiToken?.amount ?? 0)
            .plus(props.mode === 'utxosToAccount' ? amount : amount.negated())
            .toFixed(8),
