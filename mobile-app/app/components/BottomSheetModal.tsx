...
export const BottomSheetModal = (props: Props): JSX.Element => {
  ...
  return (
    <View>
      <TouchableOpacity onPress={openModal}>{triggerComponent}</TouchableOpacity>
      {!isWeb && (
        <Modal
          name={name}
          style={style}
          ...
          backgroundComponent={(backgroundProps: BottomSheetBackgroundProps) => (
            <View
              ...
              style={[
                ...
                tailwind(`${isLight ? 'bg-white border-gray-200' : 'bg-dfxblue-800 border-dfxblue-900'} rounded`),
              ]}
            />
          )}
