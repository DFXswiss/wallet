...
import { ThemedViewV2, ThemedIcon, ThemedProps, ThemedSectionTitleV2, ThemedTextInputV2 } from '@components/themed';
...
export const WalletTextInputV2 = forwardRef<any, WalletTextInputProps>(function (
  ...
  return (
    ...
    >
      {title !== undefined && <ThemedSectionTitleV2 testID={titleTestID} text={title} />}
      <ThemedViewV2
...
const TextInputDefault = forwardRef((props: WalletTextInputProps, ref: React.Ref<any>) => {
  ...
  return <ThemedTextInputV2 keyboardType={inputType} ref={ref} {...otherProps} />;
});
