            ...
            >
              ...
              <BottomTab.Screen
                ...
                options={{
                  ...
                  tabBarIcon: ({ color }) => <MaterialIcons color={color} name="swap-horiz" size={24} />,
                }}
              />
              ...
              {(isFeatureAvailable('loan') || vaults?.length > 0) && (
                <BottomTab.Screen
                  ...
                  options={{
                    ...
                    tabBarIcon: ({ color }) => <MaterialIcons color={color} name="credit-card" size={24} />,
                  }}
                />
              )}
              ...
              {isFeatureAvailable('auction') && (
                <BottomTab.Screen
                  ...
                  options={{
                    ...
                    tabBarIcon: ({ color }) => <MaterialIcons color={color} name="gavel" size={24} />,
                  }}
                />
              )}
