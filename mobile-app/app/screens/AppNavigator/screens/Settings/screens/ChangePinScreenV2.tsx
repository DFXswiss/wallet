...
export function ChangePinScreenV2({ route }: Props): JSX.Element {
  ...
  return (
    <ThemedScrollViewV2 style={tailwind('w-full flex-1 flex-col')} testID="screen_create_pin">
      ...
      <PinTextInputV2 cellCount={6} onChange={setNewPin} testID="pin_input" value={newPin} />
