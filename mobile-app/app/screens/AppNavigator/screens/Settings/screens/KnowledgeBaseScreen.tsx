...
export function KnowledgeBaseScreen({ navigation }: Props): JSX.Element {
  ...
  return (
    <ThemedScrollView style={tailwind('flex-1 pb-8')} testID="knowledge_base_screen">
      <ThemedSectionTitle testID="knowledge_base_title" text={translate('screens/KnowledgeBase', 'LEARN ABOUT')} />
...
function NavigateItemRow({
  ...
  return (
    <ThemedTouchableOpacity
      ...
      testID={testID}
    >
      <ThemedText style={tailwind('font-medium')}>{translate('screens/KnowledgeBase', label)}</ThemedText>
