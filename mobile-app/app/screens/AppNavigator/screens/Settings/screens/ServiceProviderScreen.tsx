...
export function ServiceProviderScreen({ navigation }: Props): JSX.Element {
  ...
  return (
    <ThemedScrollView light={tailwind('bg-white')} style={tailwind('px-4')}>
          ...
          >
            ...
            >
              {translate(
                ...
                'Adding malicious service providers may result in irrecoverable funds. Please proceed at your own risk.',
              )}
            </ThemedText>
          </ThemedView>
        </View>
      ...
      <ThemedText style={tailwind('text-sm pt-2')} light={tailwind('text-gray-400')} dark={tailwind('text-gray-500')}>
