...
export const BottomSheetAssetSortList = ({
  ...
  memo(() => {
    ...
    const highestCurrencyValue = translate(
      ...
      'Highest {{modifiedDenominationCurrency}} value',
      { modifiedDenominationCurrency },
    );
    ...
    const renderItem = ({ item, index }: { item: PortfolioSortType; index: number }): JSX.Element => {
      return (
        ...
        >
          <ThemedText>{translate('screens/PortfolioScreen', getDisplayedSortText(item))}</ThemedText>
