    ...
    >
      <ThemedView style={tailwind('mx-4')} dark={tailwind('bg-dfxblue-900')}>
        ...
        >
          {props.type === LayoverType.SepaInstantOverlay &&
            translate(
              'components/SepaInstantLayover',
              'Both DFX and your bank support SEPA instant transfers. This means that we can process your deposit even faster if you use this option.',
            )}
          {props.type === LayoverType.BuySuccessOverlay &&
            translate(
              'components/SepaInstantLayover',
              'As soon as the bank transfer arrives on our bank account we will book your desired asset. Thank you for using DFX.swiss.',
            )}
        </ThemedTextBasic>
        {props.type === LayoverType.SepaInstantOverlay && (
          <InfoText
            ...
            text={translate(
              'components/SepaInstantLayover',
              'Please note that your bank may charge fees for real-time payments.',
            )}
