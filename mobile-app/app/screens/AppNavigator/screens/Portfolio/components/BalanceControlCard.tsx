    ...
    >
      <View style={tailwind('flex flex-row items-center')}>
        <View>
          ...
          {addressLength > 0 && (
            <ThemedView
              ...
              style={tailwind(
                'absolute rounded-full h-6 w-6 border bottom-0 -top-1 flex justify-center items-center -right-1',
              )}
            >
              <ThemedText
        ...
        <View style={tailwind('flex flex-1 ml-3')}>
          <View style={tailwind('flex flex-row mb-0.5')}>
            <ThemedText
            ...
            backgroundComponent={(backgroundProps: BottomSheetBackgroundProps) => (
              <View
                ...
                style={[
                  ...
                  tailwind(
                    `${isLight ? 'bg-white border-gray-200' : 'bg-dfxblue-800 border-dfxblue-900'} border-t rounded`,
                  ),
                ]}
              />
            )}
