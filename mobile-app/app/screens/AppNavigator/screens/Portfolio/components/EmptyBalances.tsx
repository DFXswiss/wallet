...
export function EmptyBalances(props: EmptyBalancesProps): JSX.Element {
  ...
  return (
    <ThemedView light={tailwind('bg-gray-50')} style={tailwind('px-4 mt-8 text-center')} testID="empty_balances">
      <View style={tailwind('items-center pb-4 pr-2')}>{isLight ? <NoTokensLight /> : <DfxEmptyWalletImage />}</View>
