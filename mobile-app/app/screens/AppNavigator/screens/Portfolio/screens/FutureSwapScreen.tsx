...
export function FutureSwapScreen({ navigation }: Props): JSX.Element {
        ...
        >
          <View>
            <View style={tailwind('flex flex-row items-center mb-1')}>
              <SymbolIcon symbol={item.source.displaySymbol} styleProps={tailwind('w-4 h-4')} />
              <ThemedIcon
                size={18}
                name="arrow-right"
              ...
              />
              <SymbolIcon symbol={item.destination.displaySymbol} styleProps={tailwind('w-4 h-4')} />
            </View>
            <View style={tailwind('flex flex-row items-center mb-1')}>
              <NumberFormat
            ...
            >
              ...
              >
                {translate('screens/FutureSwapScreen', '{{percentage_change}} on oracle price', {
  ...
  return (
    <ThemedFlatList
      ...
      ListHeaderComponent={<ExecutionBlock executionBlock={executionBlock} transactionDate={transactionDate} />}
      ListFooterComponent={
        <ThemedText
