...
export function BuyConfirmationScreen ({ route }: Props): JSX.Element {
  ...
  return (
    <ThemedView style={tailwind('flex-col h-full text-lg')}>
      ...
      <ThemedTextBasic style={tailwind('flex-grow mx-12 self-center text-xl')}>
        {translate('screens/BuyConfirmationScreen', 'We will sell your assets now and prepare the payout to your bank transaction.')}
      </ThemedTextBasic>
