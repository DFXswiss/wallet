...
function ConversionIOCard(props: {
  ...
  return (
    <View style={[tailwind('flex-col w-full'), props.style]}>
      <ThemedView dark={tailwind('')} light={tailwind('')} style={tailwind('flex-row w-full items-center')}>
        <WalletTextInput
...
function ConversionReceiveCard(props: {
  style?: StyleProp<ViewStyle>;
  unit: string;
  amount: string;
  balance: string;
