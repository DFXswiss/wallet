...
export function EmptyTransaction(props: EmptyTransactionProps): JSX.Element {
  return (
    <ThemedScrollView
      refreshControl={<RefreshControl onRefresh={props.handleRefresh} refreshing={props.loadingStatus === 'loading'} />}
    ...
    >
      ...
      <ThemedText style={tailwind('text-sm pb-16 text-center opacity-60')}>
        {translate(
          ...
          'Start transacting with your wallet. All UTXO transactions made will be displayed here. Other transaction types are not supported yet.',
        )}
      </ThemedText>
