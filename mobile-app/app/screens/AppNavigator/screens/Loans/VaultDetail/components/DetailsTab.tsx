...
function VaultDetailsSection(props: { minColRatio: BigNumber; vaultInterest: BigNumber }): JSX.Element {
  return (
    <>
      <ThemedSectionTitle text={translate('components/VaultDetailDetailsTab', 'VAULT DETAILS')} />
      <NumberRow
...
function CollateralizationRatioSection(props: CollateralizationRatioSectionProps): JSX.Element {
  return (
    <>
      <ThemedSectionTitle text={translate('components/VaultDetailDetailsTab', 'COLLATERALIZATION DETAILS')} />
