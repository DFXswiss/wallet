...
function VaultIdSection({ vault, testID }: { vault: LoanVault; testID: string }): JSX.Element {
    ...
    <>
      ...
      >
        <View style={tailwind('flex flex-1')}>
          ...
          <View style={tailwind('flex flex-row mb-2 items-center')}>
            <ThemedText testID="vault_detail_id" style={tailwind('text-sm font-semibold w-8/12 flex-1 mr-2')}>
              {vault.vaultId}
            </ThemedText>
