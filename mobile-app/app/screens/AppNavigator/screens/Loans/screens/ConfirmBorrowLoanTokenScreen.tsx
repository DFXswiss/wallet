...
export function ConfirmBorrowLoanTokenScreen({ route, navigation }: Props): JSX.Element {
  const { loanToken, vault, amountToBorrow, totalInterestAmount, totalLoanWithInterest, fee, resultingColRatio } =
    route.params;
    ...
    <ThemedScrollView>
      ...
      <SummaryTransactionResults
        ...
        totalLoanValue={new BigNumber(vault.loanValue).plus(
          totalLoanWithInterest.multipliedBy(getActivePrice(loanToken.token.symbol, loanToken.activePrice)),
        )}
      />
      <SubmitButtonGroup
...
function SummaryTransactionDetails(props: SummaryTransactionDetailsProps): JSX.Element {
  return (
    <>
      <ThemedSectionTitle text={translate('screens/ConfirmBorrowLoanTokenScreen', 'TRANSACTION DETAILS')} />
      <TextRow
...
function SummaryVaultDetails(props: {
  ...
  return (
    <>
      <ThemedSectionTitle text={translate('screens/ConfirmBorrowLoanTokenScreen', 'VAULT DETAILS')} />
      <TextRow
...
function SummaryTransactionResults(props: {
  ...
  return (
    <>
      <ThemedSectionTitle text={translate('screens/ConfirmBorrowLoanTokenScreen', 'TRANSACTION RESULTS')} />
...
async function borrowLoanToken(
  { vaultId, amountToBorrow, loanToken }: BorrowForm,
