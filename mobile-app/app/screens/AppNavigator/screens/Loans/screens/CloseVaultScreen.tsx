...
function SummaryHeader(props: { vaultId: string }): JSX.Element {
  return (
    ...
    >
      ...
      <ThemedText style={tailwind('text-sm font-medium mb-1')}>{props.vaultId}</ThemedText>
    </ThemedView>
  );
}
...
function SummaryDetails(): JSX.Element {
  ...
  return (
    <>
      <ThemedSectionTitle text={translate('screens/CloseVaultScreen', 'TRANSACTION DETAILS')} />
      <WalletAddressRow />
      <NumberRow
