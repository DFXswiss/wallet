              ...
              <View style={tailwind('mt-8')}>
                <View style={tailwind('px-4 mb-12')}>
                  <WalletTextInput
                    ...
                    title={translate('screens/BorrowLoanTokenScreen', 'How many {{token}} tokens to borrow?', {
  ...
  return (
    ...
    >
      <View style={tailwind('flex flex-row w-2/12 flex-1 items-center')}>
        <SymbolIcon symbol={props.displaySymbol} styleProps={tailwind('w-6 h-6')} />
      ...
      <View style={tailwind('w-8/12 items-end flex-1')}>
        ...
        <View style={tailwind('flex-row items-center')}>
          <NumberFormat
            ...
            displayType="text"
            renderText={(value) => (
              <ThemedText style={tailwind('text-sm font-semibold text-right')}>{value}</ThemedText>
            )}
            prefix="$"
          />
          <IconTooltip />
      ...
      <View style={tailwind('mr-4 w-3/12 items-end')}>
        ...
        <NumberFormat
          ...
          thousandSeparator
          displayType="text"
          renderText={(value) => <ThemedText style={tailwind('text-sm font-semibold text-right')}>{value}</ThemedText>}
          suffix="%"
        />
      </View>
      <ThemedIcon
    ...
    >
      <View style={tailwind('flex flex-row items-center mb-2')}>
        <View style={tailwind('flex flex-row flex-1 items-center')}>
          <ThemedText ellipsizeMode="middle" numberOfLines={1} style={tailwind('w-7/12 font-medium mr-2')}>
            {props.vault.vaultId}
          </ThemedText>
        </View>
        <ThemedIcon
...
export function TransactionDetailsSection(props: TransactionDetailsProps): JSX.Element {
  ...
  return (
    <>
      <ThemedSectionTitle text={translate('screens/BorrowLoanTokenScreen', 'TRANSACTION DETAILS')} />
      ...
      <NumberRow
        ...
        rhs={{
          ...
          suffixType: 'text',
          suffix:
            props.amountToBorrowInToken.isNaN() || props.amountToBorrowInToken.isLessThan(0)
