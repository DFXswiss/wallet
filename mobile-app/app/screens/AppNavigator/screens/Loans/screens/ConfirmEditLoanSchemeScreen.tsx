...
function SummaryHeader(props: { vaultId: string }): JSX.Element {
  return (
    ...
    >
      ...
      <ThemedText testID="edit_loan_scheme_vault_id" style={tailwind('text-sm font-medium mb-1')}>
        {props.vaultId}
      </ThemedText>
    </ThemedView>
  );
...
function SummaryTransactionDetails(props: SummaryTransactionDetailsProps): JSX.Element {
  return (
    <>
      <ThemedSectionTitle text={translate('screens/ConfirmEditLoanSchemeScreen', 'TRANSACTION DETAILS')} />
      <TextRow
