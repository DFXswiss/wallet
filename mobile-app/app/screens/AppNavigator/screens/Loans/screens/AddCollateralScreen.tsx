  ...
  return (
    ...
    >
      ...
      <View style={tailwind('flex flex-1')}>
        <ThemedText style={tailwind('font-medium')} numberOfLines={1} ellipsizeMode="middle">
          {props.vaultId}
        </ThemedText>
      </View>
    </ThemedView>
    ...
    >
      ...
      >
        <View style={tailwind('flex flex-row items-center')}>
          ...
          <ThemedText style={tailwind('font-medium ml-1 mr-2')}>{props.collateralId}</ThemedText>
          <ThemedView
        ...
        <View style={tailwind('flex flex-row')}>
          <IconButton iconType="MaterialIcons" iconName="edit" iconSize={20} onPress={() => props.onEditPress(props)} />
...
function LearnMoreCollateralFactor(): JSX.Element {
  return (
    <View>
      ...
      >
        {translate(
          'screens/AddCollateralScreen',
          'Each token has their own collateral factor that would affect its respective collateral value. ',
        )}
        <TouchableOpacity
          onPress={() => {
            /* TODO: handle learn more link */
          }}
        >
          <ThemedText
