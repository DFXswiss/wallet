  ...
  return (
    ...
    >
      <LoansStack.Screen
        ...
        options={{
          headerTitle: () => (
            <HeaderTitle text={translate('screens/LoansScreen', 'Loans')} containerTestID={headerContainerTestId} />
          ),
        }}
      />
      <LoansStack.Screen
      ...
      <LoansStack.Screen
        ...
        options={{
          headerBackTitleVisible: false,
          headerTitle: () => <HeaderTitle text={translate('screens/LoansScreen', 'Create Vault')} />,
        }}
      />
      <LoansStack.Screen
        ...
        options={{
          headerBackTitleVisible: false,
          headerTitle: () => <HeaderTitle text={translate('screens/LoansScreen', 'Confirm Create Vault')} />,
        }}
      />
      <LoansStack.Screen
        ...
        options={{
          headerBackTitleVisible: false,
          headerTitle: () => <HeaderTitle text={translate('screens/LoansScreen', 'Vault Detail')} />,
        }}
      />
      <LoansStack.Screen
        ...
        options={{
          headerBackTitleVisible: false,
          headerTitle: () => <HeaderTitle text={translate('screens/LoansScreen', 'Edit Collateral')} />,
        }}
      />
      <LoansStack.Screen
        ...
        options={({ route }: { route: any }) => ({
          ...
          headerTitle: () => {
            ...
            return (
              <HeaderTitle text={translate('screens/LoansScreen', `Confirm ${isAdd ? 'Add' : 'Remove'} Collateral`)} />
            );
          },
        })}
      />
      <LoansStack.Screen
        ...
        options={{
          headerBackTitleVisible: false,
          headerTitle: () => <HeaderTitle text={translate('screens/LoansScreen', 'Choose Loan Token to Borrow')} />,
        }}
      />
      <LoansStack.Screen
        ...
        options={{
          headerBackTitleVisible: false,
          headerTitle: () => <HeaderTitle text={translate('screens/LoansScreen', 'Borrow Loan Token')} />,
        }}
      />
      <LoansStack.Screen
        ...
        options={{
          headerBackTitleVisible: false,
          headerTitle: () => <HeaderTitle text={translate('screens/LoansScreen', 'Confirm Borrow Loan Token')} />,
        }}
      />
      <LoansStack.Screen
        component={LoansFaq}
        ...
        options={{
          headerTitle: () => (
            <HeaderTitle text={translate('components/LoansFaq', 'Loans FAQ')} containerTestID={headerContainerTestId} />
          ),
          headerBackTitleVisible: false,
        }}
      />
      ...
      <LoansStack.Screen
        ...
        options={{
          headerBackTitleVisible: false,
          headerTitle: () => <HeaderTitle text={translate('screens/LoansScreen', 'Payback Loan')} />,
        }}
      />
      <LoansStack.Screen
        ...
        options={{
          headerBackTitleVisible: false,
          headerTitle: () => (
            <HeaderTitle text={translate('screens/ConfirmPaybackLoanScreen', 'Confirm Loan Payment')} />
          ),
        }}
      />
      <LoansStack.Screen
        ...
        options={{
          headerBackTitleVisible: false,
          headerTitle: () => <HeaderTitle text={translate('screens/LoansScreen', 'Edit Loan Scheme')} />,
        }}
      />
      <LoansStack.Screen
        ...
        options={{
          headerBackTitleVisible: false,
          headerTitle: () => <HeaderTitle text={translate('screens/LoansScreen', 'Confirm Edit Loan Scheme')} />,
        }}
      />
      <LoansStack.Screen
        ...
        options={{
          headerBackTitleVisible: false,
          headerTitle: () => <HeaderTitle text={translate('screens/LoansScreen', 'Borrow More')} />,
        }}
      />
      <LoansStack.Screen
        ...
        options={{
          headerBackTitleVisible: false,
          headerTitle: () => <HeaderTitle text={translate('screens/LoansScreen', 'Close Vault')} />,
        }}
      />
    </LoansStack.Navigator>
  );
