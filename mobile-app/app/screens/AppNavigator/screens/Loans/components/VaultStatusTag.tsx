...
export function VaultStatusTag({ status, testID }: { status: VaultStatus; testID?: string }): JSX.Element {
  ...
  return (
    ...
    >
      <ThemedText
        ...
        light={tailwind({
          'text-gray-500':
            status === VaultStatus.Empty || status === VaultStatus.Ready || status === VaultStatus.Liquidated,
