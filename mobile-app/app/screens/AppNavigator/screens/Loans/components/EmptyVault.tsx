...
export function EmptyVault(props: EmptyVaultProps): JSX.Element {
  ...
  return (
    <ThemedScrollView
      refreshControl={<RefreshControl onRefresh={props.handleRefresh} refreshing={props.isLoading} />}
    ...
    >
      ...
      <View style={tailwind('flex items-center')}>
        <InfoTextLink onPress={goToVaultsFaq} text="Learn more about vaults" testId="empty_vault_learn_more" />
