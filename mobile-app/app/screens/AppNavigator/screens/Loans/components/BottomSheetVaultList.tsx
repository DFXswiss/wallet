          ...
          return (
            ...
            >
              <View style={tailwind('flex flex-row w-6/12 flex-1 mr-12')}>
                <ThemedText ellipsizeMode="middle" numberOfLines={1} style={tailwind('w-4/12 flex-grow mr-2')}>
                  {item.vaultId}
                </ThemedText>
              ...
              <View style={tailwind('flex items-end')}>
                ...
                <CollateralizationRatio
                  totalLoanAmount={
                    item.state === LoanVaultState.IN_LIQUIDATION ? new BigNumber(0) : new BigNumber(item.loanValue)
                  }
                  colRatio={
