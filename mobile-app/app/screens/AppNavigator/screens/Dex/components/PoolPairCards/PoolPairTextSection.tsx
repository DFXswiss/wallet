...
export const PoolPairTextSection = React.memo(({ symbolA, symbolB }: PoolPairTextSectionProps): JSX.Element => {
  ...
  return (
    <View style={tailwind('flex-row flex-shrink break-words items-center')}>
      ...
      <ThemedText style={tailwind('text-lg font-medium max-w-4/5')} testID={`your_symbol_${poolpairSymbol}`}>
        {poolpairSymbol}
      </ThemedText>
    </View>
  );
