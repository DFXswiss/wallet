...
export function EmptyActivePoolpair(): JSX.Element {
  return (
    ...
    >
      <ThemedIcon iconType="MaterialCommunityIcons" name="circle-off-outline" size={48} style={tailwind('mb-6')} />
      <ThemedText style={tailwind('text-2xl font-semibold text-center mb-1')}>
