...
export function EmptyAuction(): JSX.Element {
  ...
  return (
    <ThemedView style={tailwind('px-8 mt-8 pb-2 pt-32 text-center')} testID="empty_auctions_screen">
      <ThemedIcon
      ...
      <View style={tailwind('flex items-center')}>
        <InfoTextLink onPress={goToAuctionsFaq} text="Learn about auctions" testId="empty_auctions_learn_more" />
      </View>
    </ThemedView>
  );
}
