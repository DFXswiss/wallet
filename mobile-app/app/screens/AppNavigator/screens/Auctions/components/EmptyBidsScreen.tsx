...
export function EmptyBidsScreen(): JSX.Element {
  return (
    <ThemedView style={tailwind('px-8 mt-8 pb-2 pt-32 text-center')} testID="empty_bid">
      <ThemedIcon
      ...
      <View style={tailwind('flex items-center')}>
        <InfoTextLink onPress={() => {}} text="Learn more about auctions and bidding" testId="empty_bid_learn_more" />
      </View>
    </ThemedView>
  );
}
