      ...
      >
              ...
              text:
                bidAmount === '' || (hasSufficientFunds && isValidMinBid)
                  ...
                  : translate(
                      ...
                      !hasSufficientFunds ? 'Insufficient funds' : 'Bid amount is lower than required',
                    ),
            }}
          >
            <SetAmountButton
        ...
        <View>
          <Button
            ...
            disabled={
              blocksRemaining === 0 || !isValidMinBid || !hasSufficientFunds || hasPendingJob || hasPendingBroadcastJob
            }
            onPress={onSubmit}
    ...
    >
      <View style={tailwind('flex flex-row items-center mb-2 justify-between')}>
        <View style={tailwind('flex flex-row w-6/12 items-center')}>
          <SymbolIcon symbol={props.displaySymbol} styleProps={tailwind('w-5 h-5')} />
