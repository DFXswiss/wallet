...
export function ConfirmPlaceBidScreen(props: Props): JSX.Element {
  ...
  const { bidAmount, estimatedFees, totalAuctionValue, vault, batch } = props.route.params;
  ...
  return (
    <ThemedScrollView testID="confirm_place_bid_screen" contentContainerStyle={tailwind('py-6 pb-8')}>
      <ThemedSectionTitle
      ...
      />
      <InfoRow type={InfoType.EstimatedFee} value={estimatedFees.toFixed(8)} testID="text_fee" suffix="DFI" />
