...
export function PlaygroundWallet(): JSX.Element | null {
  ...
  return (
    <View>
      <PlaygroundTitle status={{ online: wallets.length > 0, offline: wallets.length === 0 }} title="Wallet" />

      <PlaygroundAction onPress={clearWallets} testID="playground_wallet_clear" title="Clear stored mnemonic seed" />
