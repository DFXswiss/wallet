...
function ConnectionErrorComponent(): JSX.Element {
  ...
  return (
    <ThemedView style={tailwind('flex-1 items-center justify-center px-8')} testID="connection_error">
      <ThemedIcon iconType="MaterialIcons" name="wifi-off" size={44} style={tailwind('pb-5 text-center')} />
