  ...
  return (
    ...
    >
      <View style={tailwind('px-5 mb-12')}>
        <CreateWalletStepIndicatorV2 current={1} steps={RESTORE_STEPS} style={tailwind('px-16')} />
            ...
            render={({ field: { name, value, onChange }, fieldState: { invalid, error } }) => (
              <ThemedViewV2 style={tailwind('flex-row py-1.5 pr-3')}>
                <ThemedTextV2
                  ...
                  style={[
                    tailwind('ml-5 mr-1 py-2 font-normal-v2 text-sm', { 'mt-px': Platform.OS === 'android' }),
                    { width: 26 },
                  ]}
                >
                  {`${order}.`}
