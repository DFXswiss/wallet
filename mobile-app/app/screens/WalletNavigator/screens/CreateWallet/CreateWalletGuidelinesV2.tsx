  ...
  return (
    <ThemedScrollViewV2 contentContainerStyle={tailwind('pt-12 px-5 pb-16')} style={tailwind('flex-1')}>
      <View style={tailwind('flex flex-row justify-center')}>
        <Image style={{ width: 200, height: 136 }} source={isLight ? LightNewWallet : DarkNewWallet} />
      </View>
      <ThemedTextV2 style={tailwind('mt-7 px-3 text-base font-normal-v2 text-center')}>
        {translate(
          'screens/Guidelines',
