...
export function PinConfirmationV2({ route }: Props): JSX.Element {
  ...
  function verifyPin(input: string): void {
    ...
    setSpinnerMessage(
      translate('screens/PinConfirmation', 'It may take a few seconds to securely encrypt your wallet...'),
    );
    setTimeout(() => {
    ...
    setSpinnerMessage(
      translate('screens/PinConfirmation', 'It may take a few seconds to secure and encrypt your wallet.'),
    );
  }
  ...
  return (
    ...
    >
      <View style={tailwind(['px-5 mb-5', { 'mb-12': spinnerMessage === undefined }])}>
        ...
        {spinnerMessage !== undefined && <ThemedActivityIndicatorV2 style={tailwind('py-4 my-0.5')} />}
      </View>
