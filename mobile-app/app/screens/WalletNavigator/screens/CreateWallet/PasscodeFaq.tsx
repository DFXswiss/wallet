...
export function PasscodeFaq(): JSX.Element {
  const faqContent: AccordionContent[] = [
    {
      title: translate(
        ...
        'What happens if I forgot my passcode? Can someone help me to retrieve my passcode?',
      ),
      content: [
        {
          text: translate(
            'components/PasscodeFaq',
            'Your passcode is your responsibility, hence no one, aside from you, knows it. It is important that you keep your passcode safe and change it from time to time.',
          ),
          type: 'paragraph',
        },
      ],
      ...
      content: [
        {
          text: translate(
            'components/PasscodeFaq',
            'Yes, you can change your passcode from your settings in-app. We recommend changing of passcode regularly for maximum security.',
          ),
          type: 'paragraph',
        },
      ],
  ...
  return (
    <ThemedScrollView contentContainerStyle={tailwind('p-6 pb-8')} testID="passcode_faq">
