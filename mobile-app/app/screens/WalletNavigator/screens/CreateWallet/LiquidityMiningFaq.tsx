...
export function LiquidityMiningFaq(): JSX.Element {
      ...
      content: [
        {
          text: translate(
            'components/LiquidityMiningFaq',
            'Liquidity tokens can only be sent to another DFI wallet address or DFX, and not to an other exchange of central entity.',
          ),
          type: 'paragraph',
        },
      ],
  ...
  return (
    <ThemedScrollView contentContainerStyle={tailwind('p-6 pb-8')} testID="liquidity_mining_faq">
