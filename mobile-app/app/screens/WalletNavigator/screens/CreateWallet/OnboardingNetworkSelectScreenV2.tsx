...
export function OnboardingNetworkSelectScreenV2(): JSX.Element {
  ...
  const { count: blockCount, masternodeCount, lastSuccessfulSync } = useSelector((state: RootState) => state.block);
  ...
  return (
    <ThemedViewV2 testID="network_details" style={tailwind('px-5 flex-1')}>
      ...
      <ThemedSectionTitleV2 testID="network_details_block_info" text={translate('screens/NetworkDetails', 'DETAILS')} />
      <ThemedViewV2
