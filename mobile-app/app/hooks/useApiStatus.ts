...
export function useApiStatus(): {
  ...
  const { data: blockchainStatus, isSuccess: isBlockchainSuccess } = useGetBlockchainStatusQuery(
    {},
    {
  ...
  const { data: oceanStatus, isSuccess: isOceanSuccess } = useGetOceanStatusQuery({});
